...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/22 20:44:47 by kdagmer           #+#    #+#             */
/*   Updated: 2019/11/06 12:39:03 by kdagmer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static ssize_t	gnl_read_file(t_gnl *file)
{
...
int				get_next_line(const int fd, char **line)
{
	...
	if ((r = gnl_read_file(file)) == -1)
		return (-1);
	temp = file->buff;
	if ((endl = (ft_strchr(file->buff, '\n') > 0)))
		*line = ft_strsub(file->buff, 0, \
		ft_strchr(file->buff, '\n') - file->buff);
	else
